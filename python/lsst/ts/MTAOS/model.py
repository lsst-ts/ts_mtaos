...
class Model:
    ...
    def __init__(
        ...
        self.wep_process_started = make_done_future()
    ...
    async def process_comcam(
        ...
        """
        self.wep_process_started = asyncio.Future()
        ...
        self.wep_process_started.set_result(True)
    ...
    async def interrupt_wep_process(self):
        ...
        if self.wep_process is not None:
            ...
            await self.wep_process_started
